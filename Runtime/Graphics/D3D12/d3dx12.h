...
struct CD3DX12_VIEWPORT : public D3D12_VIEWPORT
{
		...
		FLOAT maxDepth = D3D12_MAX_DEPTH)
	{
		...
		const unsigned int64 SubresourceWidth = Desc.Width >> mipSlice;
		const unsigned int64 SubresourceHeight = Desc.Height >> mipSlice;
...
struct CD3DX12_DEPTH_STENCIL_DESC : public D3D12_DEPTH_STENCIL_DESC
{
	...
	explicit CD3DX12_DEPTH_STENCIL_DESC(
		...
		BOOL stencilEnable,
		unsigned int8 stencilReadMask,
		unsigned int8 stencilWriteMask,
...
struct CD3DX12_SUBRESOURCE_TILING : public D3D12_SUBRESOURCE_TILING
{
	...
	CD3DX12_SUBRESOURCE_TILING(
		...
		unsigned int16 heightInTiles,
		unsigned int16 depthInTiles,
...
struct CD3DX12_PACKED_MIP_INFO : public D3D12_PACKED_MIP_INFO
{
	...
	{}
	CD3DX12_PACKED_MIP_INFO(
		unsigned int8 numStandardMips,
		unsigned int8 numPackedMips,
...
struct CD3DX12_SUBRESOURCE_FOOTPRINT : public D3D12_SUBRESOURCE_FOOTPRINT
{
		...
		unsigned int rowPitch)
	{
		...
		Width = unsigned int(resDesc.Width);
...
struct CD3DX12_TEXTURE_COPY_LOCATION : public D3D12_TEXTURE_COPY_LOCATION
{
	...
	CD3DX12_TEXTURE_COPY_LOCATION(ID3D12Resource* pRes, unsigned int Sub)
	{
		pResource = pRes;
...
struct CD3DX12_ROOT_DESCRIPTOR : public D3D12_ROOT_DESCRIPTOR
{
	...
	static inline void Init(_Out_ D3D12_ROOT_DESCRIPTOR &table, unsigned int shaderRegister, unsigned int registerSpace = 0)
	{
...
struct CD3DX12_ROOT_SIGNATURE_DESC : public D3D12_ROOT_SIGNATURE_DESC
{
	...
	CD3DX12_ROOT_SIGNATURE_DESC(
		...
		unsigned int numStaticSamplers = 0,
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE
{
	...
	CD3DX12_CPU_DESCRIPTOR_HANDLE(_In_ const D3D12_CPU_DESCRIPTOR_HANDLE &other, INT offsetInDescriptors, unsigned int descriptorIncrementSize)
	{
		InitOffsetted(other, offsetInDescriptors, descriptorIncrementSize);
	}
	CD3DX12_CPU_DESCRIPTOR_HANDLE& Offset(INT offsetInDescriptors, unsigned int descriptorIncrementSize)
	{
	...
	inline void InitOffsetted(_In_ const D3D12_CPU_DESCRIPTOR_HANDLE &base, INT offsetInDescriptors, unsigned int descriptorIncrementSize)
	{
	...
	static inline void InitOffsetted(_Out_ D3D12_CPU_DESCRIPTOR_HANDLE &handle, _In_ const D3D12_CPU_DESCRIPTOR_HANDLE &base, INT offsetInDescriptors, unsigned int descriptorIncrementSize)
	{
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE : public D3D12_GPU_DESCRIPTOR_HANDLE
{
	...
	CD3DX12_GPU_DESCRIPTOR_HANDLE(_In_ const D3D12_GPU_DESCRIPTOR_HANDLE &other, INT offsetInDescriptors, unsigned int descriptorIncrementSize)
	{
		InitOffsetted(other, offsetInDescriptors, descriptorIncrementSize);
	}
	CD3DX12_GPU_DESCRIPTOR_HANDLE& Offset(INT offsetInDescriptors, unsigned int descriptorIncrementSize)
	{
		ptr += offsetInDescriptors * descriptorIncrementSize;
		return *this;
	}
	...
	inline void InitOffsetted(_In_ const D3D12_GPU_DESCRIPTOR_HANDLE &base, INT offsetInDescriptors, unsigned int descriptorIncrementSize)
	{
		InitOffsetted(*this, base, offsetInDescriptors, descriptorIncrementSize);
	}
	...
	static inline void InitOffsetted(_Out_ D3D12_GPU_DESCRIPTOR_HANDLE &handle, _In_ const D3D12_GPU_DESCRIPTOR_HANDLE &base, INT offsetInDescriptors, unsigned int descriptorIncrementSize)
	{
		handle.ptr = base.ptr + offsetInDescriptors * descriptorIncrementSize;
	}
};
...
//------------------------------------------------------------------------------------------------
inline unsigned int D3D12CalcSubresource(unsigned int MipSlice, unsigned int ArraySlice, unsigned int PlaneSlice, unsigned int MipLevels, unsigned int ArraySize)
{
...
inline void D3D12DecomposeSubresource(unsigned int Subresource, unsigned int MipLevels, unsigned int ArraySize, _Out_ T& MipSlice, _Out_ U& ArraySlice, _Out_ V& PlaneSlice)
{
...
//------------------------------------------------------------------------------------------------
inline unsigned int8 D3D12GetFormatPlaneCount(
...
struct CD3DX12_RESOURCE_DESC : public D3D12_RESOURCE_DESC
{
	...
	CD3DX12_RESOURCE_DESC(
		...
		unsigned int64 alignment,
		unsigned int64 width,
		unsigned int height,
		unsigned int16 depthOrArraySize,
		unsigned int16 mipLevels,
		DXGI_FORMAT format,
	...
	static inline CD3DX12_RESOURCE_DESC Tex1D(
		DXGI_FORMAT format,
		unsigned int64 width,
		unsigned int16 arraySize = 1,
		unsigned int16 mipLevels = 0,
		D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE,
	...
	inline unsigned int16 Depth() const
	{
		return (Dimension == D3D12_RESOURCE_DIMENSION_TEXTURE3D ? DepthOrArraySize : 1);
	}
	inline unsigned int16 ArraySize() const
	{
		return (Dimension != D3D12_RESOURCE_DIMENSION_TEXTURE3D ? DepthOrArraySize : 1);
	}
	inline unsigned int8 PlaneCount(_In_ ID3D12Device* pDevice) const
	{
		return D3D12GetFormatPlaneCount(pDevice, Format);
	}
	inline unsigned int Subresources(_In_ ID3D12Device* pDevice) const
	{
		return MipLevels * ArraySize() * PlaneCount(pDevice);
	}
	inline unsigned int CalcSubresource(unsigned int MipSlice, unsigned int ArraySlice, unsigned int PlaneSlice)
	{
...
inline unsigned int64 GetRequiredIntermediateSize(
	_In_ ID3D12Resource* pDestinationResource,
	_In_range_(0, D3D12_REQ_SUBRESOURCES) unsigned int FirstSubresource,
	_In_range_(0, D3D12_REQ_SUBRESOURCES - FirstSubresource) unsigned int NumSubresources)
{
	D3D12_RESOURCE_DESC Desc = pDestinationResource->GetDesc();
	unsigned int64 RequiredSize = 0;
...
inline unsigned int64 UpdateSubresources(
	_In_ ID3D12GraphicsCommandList* pCmdList,
	_In_ ID3D12Resource* pDestinationResource,
	_In_ ID3D12Resource* pIntermediate,
	_In_range_(0, D3D12_REQ_SUBRESOURCES) unsigned int FirstSubresource,
	_In_range_(0, D3D12_REQ_SUBRESOURCES - FirstSubresource) unsigned int NumSubresources,
	unsigned int64 RequiredSize,
	_In_reads_(NumSubresources) const D3D12_PLACED_SUBRESOURCE_FOOTPRINT* pLayouts,
	_In_reads_(NumSubresources) const unsigned int* pNumRows,
	_In_reads_(NumSubresources) const unsigned int64* pRowSizesInBytes,
	_In_reads_(NumSubresources) const D3D12_SUBRESOURCE_DATA* pSrcData)
{
	...
	{
		CD3DX12_BOX SrcBox(unsigned int(pLayouts[0].Offset), unsigned int(pLayouts[0].Offset + pLayouts[0].Footprint.Width));
...
inline unsigned int64 UpdateSubresources(
	...
	_In_ ID3D12Resource* pDestinationResource,
	_In_ ID3D12Resource* pIntermediate,
	unsigned int64 IntermediateOffset,
	_In_range_(0, D3D12_REQ_SUBRESOURCES) unsigned int FirstSubresource,
	_In_range_(0, D3D12_REQ_SUBRESOURCES - FirstSubresource) unsigned int NumSubresources,
	_In_reads_(NumSubresources) D3D12_SUBRESOURCE_DATA* pSrcData)
{
	unsigned int64 RequiredSize = 0;
	unsigned int64 MemToAlloc = static_cast<unsigned int64>(sizeof(D3D12_PLACED_SUBRESOURCE_FOOTPRINT) + sizeof(unsigned int) + sizeof(unsigned int64)) * NumSubresources;
	...
	unsigned int64* pRowSizesInBytes = reinterpret_cast<unsigned int64*>(pLayouts + NumSubresources);
	unsigned int* pNumRows = reinterpret_cast<unsigned int*>(pRowSizesInBytes + NumSubresources);
	...
	unsigned int64 Result = UpdateSubresources(pCmdList, pDestinationResource, pIntermediate, FirstSubresource, NumSubresources, RequiredSize, pLayouts, pNumRows, pRowSizesInBytes, pSrcData);
...
template <unsigned int MaxSubresources>
inline unsigned int64 UpdateSubresources(
	_In_ ID3D12GraphicsCommandList* pCmdList,
	_In_ ID3D12Resource* pDestinationResource,
	_In_ ID3D12Resource* pIntermediate,
	unsigned int64 IntermediateOffset,
	_In_range_(0, MaxSubresources) unsigned int FirstSubresource,
	_In_range_(1, MaxSubresources - FirstSubresource) unsigned int NumSubresources,
	_In_reads_(NumSubresources) D3D12_SUBRESOURCE_DATA* pSrcData)
{
	unsigned int64 RequiredSize = 0;
	D3D12_PLACED_SUBRESOURCE_FOOTPRINT Layouts[MaxSubresources];
	unsigned int NumRows[MaxSubresources];
	unsigned int64 RowSizesInBytes[MaxSubresources];
	...
	_Always_(_Outptr_opt_result_maybenull_) ID3DBlob** ppErrorBlob)
{
	...
	case D3D_ROOT_SIGNATURE_VERSION_1_0:
		...
		case D3D_ROOT_SIGNATURE_VERSION_1_1:
		{
			...
			for (unsigned int n = 0; n < desc_1_0.NumParameters; n++)
			{
