...
inline float get_wheel_temperature(int i) { return is_valid_wheel(i) ? wheels[i].thermal.avg_surface() : 0.0f; }
    ...
    inline float       get_engine_output_torque()  { return engine_output_torque; }
    ...
    inline float       get_axle_drive_torque()     { return axle_drive_torque; }

    inline float       get_longitudinal_accel()    { return longitudinal_accel; }

    inline float       get_lateral_accel()         { return lateral_accel; }

    inline bool        get_vehicle_sleeping()      { return vehicle_sleeping; }
