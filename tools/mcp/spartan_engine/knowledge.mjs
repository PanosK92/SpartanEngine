...
export const engine_overview = [
  ...
  "For blockouts and area construction, resolve or create the parent with entity_resolve/entity_create_empty, then build with entity_create_primitive_batch and entity_create_light.",
