...
export const engine_overview = [
  ...
  "Read spartan://engine/parametric-modeling before generating detailed furniture; it defines dimensions, budgets, shape selection, and recipes.",
...
export const scene_planning_guide = [
  ...
  "Call scene_visual_review after deterministic checks. Inspect composition, repetition, readability, exposure, intersections, and empty areas, then make at least one targeted correction.",
...
export const parametric_modeling_guide = [
  ...
  "- extruded_profile: custom wall outlines, frames, handles, brackets, and silhouettes",
  ...
  "- profiles: 3 to 32 points and convex for extruded caps",
  ...
  "## Material guidance",
  "",
  "Call material_palette_create before compound_create. Use distinct semantic materials for painted wall, wood, black plastic, screen, metal, fabric, glass, and emissive details. Palette input colors are converted from sRGB theme colors to linear material colors automatically.",
  "",
