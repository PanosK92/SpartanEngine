...
export const engine_overview = [
  ...
  "world_save automatically prunes unreferenced mesh, material, and texture files from the loaded world's managed resources directory. The shared project/mcp_resources library is excluded. Use world_resources_clean for an explicit cleanup receipt.",
...
export const parametric_modeling_guide = [
  ...
  "## Budgets",
  "",
  "- environment props: target about 6000 triangles, 12 authored parts and 4 reused materials",
  "- rounded_box segments: 2 for background props, 4 for normal environment props, 6 to 8 only for explicit hero assets, maximum 16",
  "- revolved_profile segments: 12 for small details, 16 to 24 for normal environment props, 32 to 48 only for explicit hero assets, maximum 64",
  ...
  "- compound hard limit: 64 parts, environment props still stop at 12; reuse meshes for repeated keys, shelves, legs, and slats",
  "",
